    ...
    <section className="SwapContainer">
      ...
      {path ?
        <form className="SwapForm">
          ...
          <div>
            <p>Our bot detected that you should swap on 11h39m 03/06/2024</p>
            <input id="delaySwapCheckbox" type='checkbox' value={'hello'} />
            <label for="delaySwapCheckbox">Delay swap</label>
          </div>
          <SlippageControl
